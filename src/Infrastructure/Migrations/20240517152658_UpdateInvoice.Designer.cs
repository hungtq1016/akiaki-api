...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240517152658_UpdateInvoice")]
            ...
            modelBuilder.Entity("Core.Models.User", b =>
                {
                    ...
                    b.Property<string>("Password")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("$2a$11$aEscSRd72IB7ofJTjaUvGOGcCq5Qo0HNdNhGB7HPHo0LReULOzZPW");
            ...
            modelBuilder.Entity("Core.Models.Invoice", b =>
                {
                    b.HasOne("Core.Models.HealthRecord", "HealthRecord")
                        .WithOne("Invoice")
                        .HasForeignKey("Core.Models.Invoice", "HealthRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
