...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240521021906_update-treatment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.InvoiceDetail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("Core.Models.ServicePrice", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("Core.Models.TreatmentDetail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("Core.Models.TreatmentPlant", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
            ...
            modelBuilder.Entity("Core.Models.User", b =>
                {
                    ...
                    b.Property<string>("Password")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("$2a$11$qbHG/j5i/dcFfbhoOniLJOgIJihDcWeX1H3W7aRAI0x3/knX/Vg2G");
            ...
            modelBuilder.Entity("Core.Models.Invoice", b =>
                {
                    b.HasOne("Core.Models.HealthRecord", "HealthRecord")
                        .WithMany("Invoices")
                        .HasForeignKey("HealthRecordId");

                    b.HasOne("Core.Models.User", "Nurse")
                        .WithMany("Nurses")
            ...
            modelBuilder.Entity("Core.Models.InvoiceDetail", b =>
                {
                    ...
                    b.HasOne("Core.Models.ServicePrice", "ServicePrice")
                        .WithMany("InvoiceDetails")
            ...
            modelBuilder.Entity("Core.Models.TreatmentDetail", b =>
                {
                    ...
                    b.HasOne("Core.Models.TreatmentPlant", "Treatment")
                        .WithMany("Details")
